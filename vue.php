...
$grid_width  = 8; // largeur de la grille
$grid_height = 8; // hauteur de la grille
$cell_width  = 50; // largeur d'une cellule
$cell_height = 50; // hauteur d'une cellule
...
<body>
  ...
  ?>
            <span class="cell"><?php echo $grille[$w][$h];?></span>
        <?php endfor ?>
        </div>
    <?php endfor ?>
    </div>
